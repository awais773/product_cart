            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        <label class="h4 mb-2 text-gray-800" for="">Previous level Completed</label>
                        <input type="text" class="form-control" value="{{ $dailyBouns->complete_level }}" name="complete_level"
                ...
                <div class="col-sm">
                    <div class="form-group">
                        <label class="h4 mb-2 text-gray-800" for="">New level Completed </label>
                        <input type="text" class="form-control" value="{{ $dailyBouns->advance_level }}" name="advance_level"
