    ...
    <div class="container-fluid">
        ...
        <form action="{{ url('DailyBounsupdate', $dailyBouns->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        <label class="h4 mb-2 text-gray-800" for="">1-Showads After level </label>
                        <input type="text" class="form-control" value="{{ $dailyBouns->show_advertising }}"
                            name="show_advertising" placeholder="Advertising Name">
